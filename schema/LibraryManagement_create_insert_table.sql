...
CREATE TABLE tbl_library_branch (
    library_branch_ID INT PRIMARY KEY IDENTITY(1,1),
...
CREATE TABLE tbl_borrower (
    borrower_ID INT PRIMARY KEY IDENTITY(100,1),
...
VALUES ('Test Borrower', 'No Loan Street', '000-000-0000');

    
    SELECT * FROM tbl_borrower
---------------------------------------------------
CREATE TABLE tbl_book_loans (
    book_loans_ID INT PRIMARY KEY IDENTITY(1,1),
...
VALUES
-- Book 1 to 20 in Sharpstown (BranchID = 1)
(1, 1, 5), (2, 1, 7), (3, 1, 4), (4, 1, 6), (5, 1, 3),
(6, 1, 8), (7, 1, 5), (8, 1, 10), (9, 1, 6), (10, 1, 7),
(11, 1, 4), (12, 1, 9), (13, 1, 6), (14, 1, 8), (15, 1, 5),
(16, 1, 7), (17, 1, 6), (18, 1, 9), (19, 1, 8), (20, 1, 10),

-- Book 1 to 20 in Central (BranchID = 2)
(1, 2, 6), (2, 2, 5), (3, 2, 8), (4, 2, 7), (5, 2, 9),
(6, 2, 4), (7, 2, 6), (8, 2, 11), (9, 2, 8), (10, 2, 7),
(11, 2, 5), (12, 2, 6), (13, 2, 7), (14, 2, 9), (15, 2, 6),
(16, 2, 10), (17, 2, 8), (18, 2, 7), (19, 2, 11), (20, 2, 9),

-- Book 1 to 20 in Saline (BranchID = 3)
(1, 3, 4), (2, 3, 6), (3, 3, 5), (4, 3, 8), (5, 3, 7),
(6, 3, 9), (7, 3, 4), (8, 3, 10), (9, 3, 5), (10, 3, 6),
(11, 3, 8), (12, 3, 7), (13, 3, 6), (14, 3, 5), (15, 3, 9),
(16, 3, 7), (17, 3, 6), (18, 3, 10), (19, 3, 8), (20, 3, 12),

-- Book 1 to 20 in Ann Arbor (BranchID = 4)
(1, 4, 7), (2, 4, 8), (3, 4, 9), (4, 4, 6), (5, 4, 10),
(6, 4, 11), (7, 4, 12), (8, 4, 9), (9, 4, 10), (10, 4, 8),
(11, 4, 7), (12, 4, 9), (13, 4, 8), (14, 4, 11), (15, 4, 10),
(16, 4, 12), (17, 4, 9), (18, 4, 11), (19, 4, 8), (20, 4, 10);
...
CREATE TABLE tbl_book_authors (
    ...
    PRIMARY KEY (book_authors_BookID, book_authors_AuthorName)
);
